...
public class SingleEventSourcePublisher80 {
    private static final Logger log = Logger.getLogger(SingleEventSourcePublisher80.class);

    private static final String SOURCE_ID = "SOURCE1";
    private static final int EVENT_BATCH_SIZE = 20;
    private static final double OUT_OF_ORDER_PERCENTAGE = 0.8;
